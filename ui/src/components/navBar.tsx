                ...
                <Menu as="div" className="ml-3 relative">
                  <div>
                    <Menu.Button className="bg-gray-800 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                      ...
                      <div
                        className="h-8 w-8 rounded-full bg-blue-300 flex items-center justify-center font-bold text-lg"
                      >{localStorage.getItem('xenName')?.toLocaleUpperCase().charAt(0)}</div>
                    </Menu.Button>
                  </div>
                  <Transition
                    as={Fragment}
